...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		return awe\_weapons::getFragGrenadeCount();
	}
////////////////////////////////////////
	if(self.pers["team"] == "allies")
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		return awe\_weapons::getSmokeGrenadeCount();
	}
////////////////////////////////////////
	if(self.pers["team"] == "allies")
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		return awe\_weapons::restrictWeaponByServerCvars(response);
	}
////////////////////////////////////////
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		self awe\_weapons::watchWeaponUsage();
		return;
	}
////////////////////////////////////////
