...
// La Truffe ->
//////// Changed for AWE (lms and ihtf and hm) ////////
//	if(getcvar("g_gametype") == "dm" || getcvar("g_gametype") == "lms" || getcvar("g_gametype") == "ihtf" || level.maxclients < 2)
	if(getcvar("g_gametype") == "dm" || getcvar("g_gametype") == "lms" || getcvar("g_gametype") == "ihtf" || getcvar("g_gametype") == "hm" || level.maxclients < 2)
// La Truffe <-
////////////////////////////////////////////////
	{
		joinallies = 1;
