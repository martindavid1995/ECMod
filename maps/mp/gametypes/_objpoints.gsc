...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		awe\_objpoints::addObjpoint(origin, name, material);
		return;
	}
////////////////////////////////////////
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		awe\_objpoints::addTeamObjpoint(origin, name, team, material);
		return;
	}
////////////////////////////////////////
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		awe\_objpoints::removeObjpoints();
		return;
	}
////////////////////////////////////////
...
//////// Added for AWE  ////////////////
	if(!level.awe_disable)
	{
		awe\_objpoints::removeTeamObjpoints(team);
		return;
	}
////////////////////////////////////////
