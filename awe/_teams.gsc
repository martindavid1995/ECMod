...
{
////////// Added for AWE ///////////
	level.awe_allowteamselect = awe\_util::cvardef("awe_allow_team_select", 1, 0, 1, "int");
////////////////////////////////////
...
//	if(getcvar("g_gametype") != "dm" && getcvar("g_gametype") != "lms" && getcvar("g_gametype") != "ihtf")
	if(getcvar("g_gametype") != "dm" && getcvar("g_gametype") != "lms" && getcvar("g_gametype") != "ihtf" && getcvar("g_gametype") != "hm")
// La Truffe <-
/////////////////////////////////////////////////
	{
...
// La Truffe ->
//	else if(getcvar("g_gametype") == "dm" || getcvar("g_gametype") == "lms" || getcvar("g_gametype") == "ihtf" || level.maxclients < 2)
	else if(getcvar("g_gametype") == "dm" || getcvar("g_gametype") == "lms" || getcvar("g_gametype") == "ihtf" || getcvar("g_gametype") == "hm" || level.maxclients < 2)
// La Truffe <-
////////////////////////////////////////////////
	{
		joinallies = 1;
