//the only difference this has from the vanilla killcam is the ability to modify the length of time
//that the killcam records... i believe... 
...
killcam(attackerNum, delay, offsetTime, respawn)
{
	...
	self.archivetime = delay + awe\_util::cvardef("awe_killcam_time",7,0,45,"int");
